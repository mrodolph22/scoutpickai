  ...
  return (
    <div className="max-w-2xl mx-auto pb-20">
      <div className="bg-white shadow-sm border-b sticky top-0 z-10 p-4">
        <h1 className="text-xl font-bold text-center text-gray-900 mb-4">NFL Scoreboard</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <button 
            onClick={loadGames}
            className="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-blue-700 transition-colors flex items-center justify-center gap-2"
          >
      ...
      <div className="p-4">
        {loading ? (
           ...
           <div className="text-center py-10 text-red-500 bg-red-50 rounded-lg border border-red-100 m-4">
             <p>{error}</p>
             <button onClick={loadGames} className="mt-2 text-blue-600 underline text-sm">Retry</button>
           </div>
        ) : games.length === 0 ? (
           <div className="text-center py-20 text-gray-400">No games found for this week.</div>
        ) : (
